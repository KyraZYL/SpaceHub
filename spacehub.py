...
userInfo = pg.image.load('userinfo.png')
info_but = False
	...
	if first_flag:
		...
		if cont_but:
			if (int(user_ori_v) >= 20) and (int(user_ori_v) <= 40):
				...
				# reset_but = True
				warnText_cont,warnText_pos = DrawText("Please Enter an integer within the range!",400,280,textHeight=30,fontType="Graduate.ttf")
